...
class Gen2IronmonChallengeWindow:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Gen 2 Ironmon Challenge")
        self.root.geometry("800x800")
        
        empty_space_label = tk.Label(self.root, text="")
        empty_space_label.pack(side=tk.TOP, pady=15)
       
        # Pokemon buttons (Gold, Silver, and Crystal)
        self.pokemon_Gold_button = tk.Button(self.root, text="Pokemon Gold", command=self.set_picked_game_Gold)
        self.pokemon_Gold_button.place(x=250, y=10)
        
        self.pokemon_Silver_button = tk.Button(self.root, text="Pokemon Silver", command=self.set_picked_game_Silver)
        self.pokemon_Silver_button.place(x=350, y=10)
        
        self.pokemon_Crystal_button = tk.Button(self.root, text="Pokemon Crystal", command=self.set_picked_game_Crystal)
        self.pokemon_Crystal_button.place(x=450, y=10)       
    ...
    def set_picked_game_Gold(self):
        self.run_challenge("Gold")

    def set_picked_game_Silver(self):
        self.run_challenge("Silver")

    def set_picked_game_Crystal(self):
        self.run_challenge("Crystal") 
    ...
    def run_challenge(self, picked_game=None):
        ...
        if picked_game in ['Silver', 'Gold', 'Crystal']:
