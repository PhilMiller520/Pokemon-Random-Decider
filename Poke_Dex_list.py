# contains a list of all pokemon in gen 1
Gen1List = ['Bulbasaur', 'Ivysaur', 'Venusaur', 'Charmander', 'Charmeleon', 'Charizard','Squirtle', 
...
'Raichu', 'Sandshrew', 'Sandslash','Nidoran female', 'Nidorina', 'Nidoqueen', 'Nidoran male', 
...
#contains a lits of all pokemon added to the global dex in gen 3
