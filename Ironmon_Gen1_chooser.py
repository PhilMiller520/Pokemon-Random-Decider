...
import random
from Poke_Dex_list import Gen1List
import Box_Art_images
import Pokemon_images

class Gen1IronmonChallengeWindow:
    def __init__(self):
        self.root = tk.Tk()
        self.root.title("Gen 1 Ironmon Challenge")
        self.root.geometry("800x800")
        
        empty_space_label = tk.Label(self.root, text="")
        empty_space_label.pack(side=tk.TOP, pady=15)
       
        # Pokemon buttons (Blue, Red, and Yellow)
        self.pokemon_blue_button = tk.Button(self.root, text="Pokemon Blue", command=self.set_picked_game_blue)
        self.pokemon_blue_button.place(x=250, y=10)
        
        self.pokemon_red_button = tk.Button(self.root, text="Pokemon Red", command=self.set_picked_game_red)
        self.pokemon_red_button.place(x=350, y=10)
        
        self.pokemon_yellow_button = tk.Button(self.root, text="Pokemon Yellow", command=self.set_picked_game_yellow)
        self.pokemon_yellow_button.place(x=450, y=10)       
    ...
    def set_picked_game_blue(self):
        self.run_challenge("Blue")

    def set_picked_game_red(self):
        self.run_challenge("Red")

    def set_picked_game_yellow(self):
        self.run_challenge("Yellow") 
